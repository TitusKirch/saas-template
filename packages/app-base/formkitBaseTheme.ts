 ...
 *
 * @checksum - 30ee83fc62d17f9c82afff5211b84d28251e3253f1118e83fb18dc501780a049
 * @variables - radius=rounded-lg,accentColor=primary,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/

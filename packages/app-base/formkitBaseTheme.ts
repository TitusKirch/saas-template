 ...
 *
 * @checksum - 0b22189f68f6b6561c74199594a622f9e481ffcc37e4dfa44223f894ff49f041
 * @variables - radius=rounded,accentColor=primary,colorTemperature=gray,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
 * @theme - regenesis
 **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  range__input: {
    ...
    '[&::-webkit-slider-thumb]:-trangray-y-1/2': true,
  ...
  colorpicker__swatch: {
    ...
    'data-[active=true]:after:-trangray-x-1/2': true,
    'data-[active=true]:after:-trangray-y-1/2': true,
  ...
  slider__tooltip: {
    ...
    'after:top-full': true,
    'after:left-1/2': true,
    'after:-trangray-x-1/2': true,
    'after:-trangray-y-[1px]': true,
    'after:border-4': true,
  ...
  toggle__track: {
    ...
    'peer-checked:[&>div:last-child]:-trangray-x-full': true,
    'peer-checked:[&>div:first-child:not(:last-child)]:left-0': true,
    'peer-checked:[&>div:first-child:not(:last-child)]:trangray-x-0': true,
    'shadow-sm': true,
    'peer-focus-visible:ring-2': true,
  ...
  togglebuttons__input: {
    ...
    'group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-primary-500':
      true,
    'group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-primary-600':
      true,
    'group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-primary-600':
      true,
    'dark:group-data-[vertical=false]/options:group-[]/option:aria-[pressed=true]:border-x-primary-600':
      true,
    'dark:group-data-[vertical=false]/options:group-first/option:aria-[pressed=true]:border-l-primary-600':
      true,
    'dark:group-data-[vertical=false]/options:group-last/option:aria-[pressed=true]:border-r-primary-600':
      true,
    ...
    'group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-primary-500':
      true,
    'group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-primary-600':
      true,
    'group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-primary-600':
      true,
    'dark:group-data-[vertical=true]/options:group-[]/option:aria-[pressed=true]:border-y-primary-600':
      true,
    'dark:group-data-[vertical=true]/options:group-first/option:aria-[pressed=true]:border-t-primary-600':
      true,
    'dark:group-data-[vertical=true]/options:group-last/option:aria-[pressed=true]:border-b-primary-600':
      true,
  },
  transferlist__outer: {
    group: true,
  ...
  'multi-step__tab': {
    ...
    'group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-primary-600':
      true,
    ...
    'dark:group-data-[tab-style=progress]/wrapper:data-[valid=true]:data-[visited=true]:after:bg-primary-600':
      true,
  },
